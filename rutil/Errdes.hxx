...
map <string, string> X509ErrorMsg;
map <string, string> WinErrorMsg;
...
{
public:
	void CreateMappingErrorMsg(string Error, string ErrorMsg)
	{
            WinErrorMsg[Error] = ErrorMsg;            // for windows
            ErrornoErrorMsg[Error] = ErrorMsg;        // for linux 
	}
};
...
public:
	void CreateMappingErrorMsg(string Error, string ErrorMsg)
	{
		OpenSSLErrorMsg[Error] = ErrorMsg;
	}
};
...
/*    for (int i = 0; i < 134; ++i)
      {
            ErrornoObj.CreateMappingErrorMsg(ErrorCode[i], ErrorString[i]);
      }
*/
//-------------------------------------------------------------------------------------------------------------------
...
/*    for (int i = 0; i < 9; ++i)
      {
            OpenSSLObj.CreateMappingErrorMsg(OpenSSLCode[i], OpenSSLString[i]);
      }
*/
//-------------------------------------------------------------------------------------------------------------------

      string X509ErrorCode[54] = 
      {
      	"X509_V_OK",
      	...
      	"X509_V_ERR_UNABLE_TO_DECODE_ISSUER_private_KEY",
	...
	string X509ErrorString[54] = 
      {
      	...
      	"X509_V_ERR_UNABLE_TO_GET_CRL 2",
      	"X509_V_ERR_UNABLE_TO_DECRYPT_CERT_SIGNATURE 3",
      	"X509_V_ERR_UNABLE_TO_DECRYPT_CRL_SIGNATURE 4",
      	"X509_V_ERR_UNABLE_TO_DECODE_ISSUER_private_KEY 5",
      	"X509_V_ERR_CERT_SIGNATURE_FAILURE 6",
      	"X509_V_ERR_CRL_SIGNATURE_FAILURE 7",
      	"X509_V_ERR_CERT_NOT_YET_VALID 8",
      	"X509_V_ERR_CERT_HAS_EXPIRED 9",
      	"X509_V_ERR_CRL_NOT_YET_VALID 10",
      	"X509_V_ERR_CRL_HAS_EXPIRED 11",
      	"X509_V_ERR_ERROR_IN_CERT_NOT_BEFORE_FIELD 12",
      	"X509_V_ERR_ERROR_IN_CERT_NOT_AFTER_FIELD 13",
      	"X509_V_ERR_ERROR_IN_CRL_LAST_UPDATE_FIELD 14", 
      	"X509_V_ERR_ERROR_IN_CRL_NEXT_UPDATE_FIELD 15",
      	"X509_V_ERR_OUT_OF_MEM 16",
      	"X509_V_ERR_DEPTH_ZERO_SELF_SIGNED_CERT 17",
      	"X509_V_ERR_SELF_SIGNED_CERT_IN_CHAIN 18",
      	"X509_V_ERR_UNABLE_TO_GET_ISSUER_CERT_LOCALLY 19",
      	"X509_V_ERR_UNABLE_TO_VERIFY_LEAF_SIGNATURE 20",
      	"X509_V_ERR_CERT_CHAIN_TOO_LONG 21",
      	"X509_V_ERR_CERT_REVOKED 22",
      	"X509_V_ERR_INVALID_CA 23",
      	"X509_V_ERR_PATH_LENGTH_EXCEEDED 24",
      	"X509_V_ERR_INVALID_PURPOSE 25",
      	"X509_V_ERR_CERT_UNTRUSTED 26",
      	"X509_V_ERR_CERT_REJECTED 27",
      	"X509_V_ERR_SUBJECT_ISSUER_MISMATCH 28",
      	"X509_V_ERR_AKID_SKID_MISMATCH 29",
      	"X509_V_ERR_AKID_ISSUER_SERIAL_MISMATCH 30",
      	"X509_V_ERR_KEYUSAGE_NO_CERTSIGN 31",
      	"X509_V_ERR_UNABLE_TO_GET_CRL_ISSUER 32",
      	"X509_V_ERR_UNHANDLED_CRITICAL_EXTENSION 33",
      	"X509_V_ERR_KEYUSAGE_NO_CRL_SIGN 34",
      	"X509_V_ERR_UNHANDLED_CRITICAL_CRL_EXTENSION 35",
      	"X509_V_ERR_INVALID_NON_CA 36",
      	"X509_V_ERR_PROXY_PATH_LENGTH_EXCEEDED 37",
      	"X509_V_ERR_KEYUSAGE_NO_DIGITAL_SIGNATURE 38",
      	"X509_V_ERR_PROXY_CERTIFICATES_NOT_ALLOWED 39",
      	"X509_V_ERR_INVALID_EXTENSION 40",
      	"X509_V_ERR_INVALID_POLICY_EXTENSION 41",
      	"X509_V_ERR_NO_EXPLICIT_POLICY 42",
      	"X509_V_ERR_DIFFERENT_CRL_SCOPE 43",
      	"X509_V_ERR_UNSUPPORTED_EXTENSION_FEATURE 44",
      	"X509_V_ERR_UNNESTED_RESOURCE 45",
      	"X509_V_ERR_PERMITTED_VIOLATION 46",
      	"X509_V_ERR_EXCLUDED_VIOLATION 47",
      	"X509_V_ERR_SUBTREE_MINMAX 48",
      	"X509_V_ERR_APPLICATION_VERIFICATION 49",
      	"X509_V_ERR_UNSUPPORTED_CONSTRAINT_TYPE 50",
      	"X509_V_ERR_UNSUPPORTED_CONSTRAINT_SYNTAX 51",
      	"X509_V_ERR_UNSUPPORTED_NAME_SYNTAX 52",
      	"X509_V_ERR_CRL_PATH_VALIDATION_ERROR 53",
	};

/*    for (int i = 0; i < 54; ++i)
      {
            X509Obj.CreateMappingErrorMsg(X509ErrorCode[i], X509ErrorString[i]);
      }
*/

//-------------------------------------------------------------------------------------------------------------------

      string WindowsErrorCode[95] =
      {
...
/*    for (int i = 0; i < 54; ++i)
      {
            WinObj.CreateMappingErrorMsg(WindowsErrorCode[i], WindowsErrorString[i]);
      }
*/
